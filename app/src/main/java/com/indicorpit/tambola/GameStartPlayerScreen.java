...
import com.indicorpit.tambola.adapters.AdapterForPlayerTicket;
...
import com.indicorpit.tambola.databinding.ActivityGameStartPlayerScreenBinding;
import com.indicorpit.tambola.databinding.ActivityWinnerBoardBinding;
import com.indicorpit.tambola.databinding.LayoutForJoinedPlayersBinding;
import com.indicorpit.tambola.databinding.LayoutHostClaimsBinding;
import com.indicorpit.tambola.model.ClaimModelClass;
...
import com.indicorpit.tambola.viewModel.GameStartPlayerViewModel;
...
public class GameStartPlayerScreen extends AppCompatActivity {
    ...
    public static ChildEventListener childEventListenerAdapter;
    public static ChildEventListener childEventListenerAdapter2;
    public static ValueEventListener valueEventListenerAdapter;
    ...
    void  initializeScreen()
    {
        ...
        if( gameStartPlayerViewModel.GAME_PLAYER_SOUND )
        ...
        binding.speakerIcon.setOnClickListener ( view -> {
            ...
            {
                mediaPlayer.pause ();
                gameStartPlayerViewModel.GAME_PLAYER_SOUND=false;
                binding.speakerIcon.setImageResource ( R.drawable.ic_off_speaker );
            }
            else
            {
                mediaPlayer.start ();
                gameStartPlayerViewModel.GAME_PLAYER_SOUND=true;
                binding.speakerIcon.setImageResource ( R.drawable.ic_speaker_icon );
            }
        } );
        ...
        if(gameStartPlayerViewModel.getRoomCode ()==null)
        {
            ...
            childEventListener1= Database.getDatabaseReference ().child ( "Room" ).child(gameStartPlayerViewModel.getRoomCode ()).child ( "players" ).child ( gameStartPlayerViewModel.getPlayerId ( ) )
             ...
             valueEventListener1=Database.getDatabaseReference ().child ( "Room" ).child (  gameStartPlayerViewModel.getRoomCode ()).child ( "exit_players" )
            ...
            childEventListener2= Database.getDatabaseReference ().child ( "Room" ).child( gameStartPlayerViewModel.getRoomCode ( ) ).child ( "players" ).addChildEventListener (
                    new ChildEventListener ( ) {
                        @Override
                        public void onChildAdded ( @NonNull DataSnapshot snapshot , @Nullable String previousChildName ) {
                            String playerIde = snapshot.getKey ( );
                          childEventListener3=   Database.getDatabaseReference ().child ( "Room" ).child( gameStartPlayerViewModel.getRoomCode ( ) ).child ( "players" ).child ( playerIde )
                                    .child ( "tickets" ).addChildEventListener ( new ChildEventListener ( ) {
                                @Override
                                public void onChildAdded ( @NonNull DataSnapshot snapshot , @Nullable String previousChildName ) {
                                    ...
                                    assert key != null;
                                  valueEventListener2=   Database.getDatabaseReference ().child ( "Room" ).child( gameStartPlayerViewModel.getRoomCode ( ) ).child ( "players" ).child ( playerIde )
                                                ...
                                                Database.getDatabaseReference ().child ( "Room" ).child( gameStartPlayerViewModel.getRoomCode ( ) ).child ( "players" ).child ( playerIde )
                                                    ...
                                                    public void onDataChange ( @NonNull DataSnapshot snapshot ) {
                                                        ...
                                                        if(playerName!=null)
                                                        {
                                                            ...
                                                            layoutHostClaimsBinding.ticketId.setText ( claimModelClass.getTicketId ());
                                                            ...
                                                            gameStartPlayerViewModel.setClaimPending ( claimModelClass.getClaimStatus ( ).contains ( "Pending" ) );
            ...
            valueEventListener3= Database.getDatabaseReference ().child ( "Room" ).child( gameStartPlayerViewModel.getRoomCode ( ) ).child("gameOver").addValueEventListener ( new ValueEventListener ( ) {
                @Override
                public void onDataChange ( @NonNull DataSnapshot snapshot ) {
             ...
             valueEventListener4=Database.getDatabaseReference ().child ( "Room" ).child ( gameStartPlayerViewModel.getRoomCode ( ) ).child ( "status" ).addValueEventListener ( new ValueEventListener ( ) {
                @Override
                public void onDataChange ( @NonNull DataSnapshot snapshot ) {
                    ...
                    if ( roomStatus!=null )
                        ...
                        {
                            AlertDialog.Builder builder=new AlertDialog.Builder(GameStartPlayerScreen.this)
                                    ...
                                    .setCancelable ( false );
                                    if(GameStartPlayerScreen.this!=null)
                                    builder.show() ;
                        }
                }
                @Override
    ...
    protected void onCreate ( Bundle savedInstanceState ) {
        ...
        Database.getDatabaseReference ().child ( "Room" ).child(gameStartPlayerViewModel.getRoomCode ()).child("prices").addListenerForSingleValueEvent ( new ValueEventListener ( ) {
            ...
            public void onDataChange ( @NonNull DataSnapshot snapshot ) {
                ...
                if(roomModel!=null)
                {
                    ...
                    adapterForPlayerTicket=new AdapterForPlayerTicket (gameStartPlayerViewModel);
        ...
        final boolean[] firstTime = {true};
         valueEventListener5=Database.getDatabaseReference ().child ( "Room" ).child( gameStartPlayerViewModel.getRoomCode ( ) ).child ( "current_number" ).addValueEventListener ( new ValueEventListener ( ) {
            @Override
            public void onDataChange ( @NonNull DataSnapshot snapshot ) {
        ...
        binding.winnerBoard.setOnClickListener ( view -> {
            ...
            winnerBoardBinding.shareWinnerList.setVisibility ( View.GONE );
    ...
    void setNumberAnimation(String currentNumber)
    {
        ...
        binding.currentNumber.setVisibility ( View.VISIBLE );
        binding.currentNumber.setText ( currentNumber );
        ...
        public void run() {
            ...
            else
            {
                new Handler ( Looper.getMainLooper ()  ).postDelayed ( () -> {
                    ...
                    binding.currentNumber.setVisibility ( View.INVISIBLE );
...
//                    binding.secondNumberAnimationView.setVisibility ( View.INVISIBLE);
    ...
    protected void onDestroy () {
        ...
        if(childEventListener1!=null)
        Database.getDatabaseReference ().removeEventListener ( childEventListener1 );
        if(valueEventListener1!=null)
        Database.getDatabaseReference ().removeEventListener ( valueEventListener1 );
        if(childEventListener2!=null)
        Database.getDatabaseReference ().removeEventListener (  childEventListener2);
        if(childEventListener3!=null)
        Database.getDatabaseReference ().removeEventListener (  childEventListener3);
        if(valueEventListener2!=null)
        Database.getDatabaseReference ().removeEventListener (  valueEventListener2);
        if(valueEventListener3!=null)
        Database.getDatabaseReference ().removeEventListener ( valueEventListener3 );
        if(valueEventListener4!=null)
        Database.getDatabaseReference ().removeEventListener ( valueEventListener4 );
        if(valueEventListener5!=null)
        Database.getDatabaseReference ().removeEventListener ( valueEventListener5 );
        if(childEventListenerAdapter!=null)
        Database.getDatabaseReference ().removeEventListener ( childEventListenerAdapter );
        if(valueEventListenerAdapter!=null)
        Database.getDatabaseReference ().removeEventListener ( valueEventListenerAdapter );
        if(childEventListenerAdapter2!=null)
        Database.getDatabaseReference ().removeEventListener ( childEventListenerAdapter2 );
